...
git add tracker.html dashboard.html index.html driver_hours.json process_payworks.py deploy.cmd publish_tracker.cmd functions schema.sql wrangler.toml
echo.
echo --- Committing ---
